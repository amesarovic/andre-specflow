...
joined_mountains AS (
  ...
  SELECT 
    ...
    fm.longitude,
    fm.region,
    sac.GDP_Per_Capita AS country_standard_of_living
  
  FROM filtered_mountains AS fm
  JOIN south_american_countries AS sac
     ON fm.country = sac.Country_Name
